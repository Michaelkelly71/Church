        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                <ul class="nav navbar-nav ">
                    ...
                    <li class="nav-item" role="presentation">
                        <a class="nav-link js-scroll-trigger" href="frontPageevents.php">View Events</a>
                    </li>
        ...
        <div class="container my-auto">
            <div class="row">
                <div class="col-lg-10 mx-auto">
                    <h1 class="text-uppercase">GLORIOUS SAINTS WORSHIP CENTER</h1>
                    <h3>Youth Church</h3>
                    <hr>
                </div>
            </div>
            ...
            <div class="row" style="color: rgb(0,0,0);">
                ...
                <div class="col-md-6 col-lg-3 text-center">
                    <div class="mx-auto service-box mt-5">
                        ...
                        <p class="text-muted mb-0">We sought the Lord in prayer evey wednesday. He did pray without ceasing</p>
                    </div>
                </div>
                <div class="col-md-6 col-lg-3 text-center">
                    <div class="mx-auto service-box mt-5">
