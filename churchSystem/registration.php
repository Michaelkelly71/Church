...
<body class="body">
    ...
    <form  method="post" action="registration.php">
        ...
        <div class="input-group" style="height: 30px; width: 28%;">
            <label width="34%" style="color: darkblue; padding-right:230px;">Username</label>
            <label>
        ...
        <div class="input-group" style="height: 30px; width: 28%;">
            <label width="34%" style="color: darkblue; padding-right:230px;">Password</label>
            <label>
        ...
        <div class="input-group" style="height: 30px; width: 28%;">
            <label width="34%" style="color: darkblue; padding-right:180px;">Confirm Password</label>
            <label>
